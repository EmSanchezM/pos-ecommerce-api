// SubmitTransferUseCase - submits a draft transfer for processing
...
/// Use case for submitting a draft transfer
pub struct SubmitTransferUseCase<T>
where
...
impl<T> SubmitTransferUseCase<T>
where
    T: TransferRepository,
{

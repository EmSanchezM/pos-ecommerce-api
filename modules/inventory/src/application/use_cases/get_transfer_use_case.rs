// GetTransferUseCase - gets a single transfer by ID with items
...
/// Use case for getting a single stock transfer by ID
pub struct GetTransferUseCase<T>
where

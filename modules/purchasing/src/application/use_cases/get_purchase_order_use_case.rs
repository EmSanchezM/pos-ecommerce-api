// GetPurchaseOrderUseCase - retrieves a purchase order by ID
...
/// Use case for retrieving a purchase order by ID
pub struct GetPurchaseOrderUseCase<P>
where
...
impl<P> GetPurchaseOrderUseCase<P>
where
    P: PurchaseOrderRepository,
{
    /// Creates a new instance of GetPurchaseOrderUseCase
    pub fn new(order_repo: Arc<P>) -> Self {
        Self { order_repo }
    }

    /// Executes the use case to retrieve a purchase order with items
    ///
    /// # Arguments

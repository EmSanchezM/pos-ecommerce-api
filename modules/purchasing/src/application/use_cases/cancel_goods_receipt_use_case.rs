// CancelGoodsReceiptUseCase - cancels a draft goods receipt
...
/// Use case for cancelling a draft goods receipt
pub struct CancelGoodsReceiptUseCase<G>
where
...
impl<G> CancelGoodsReceiptUseCase<G>
where
    G: GoodsReceiptRepository,
{
    /// Creates a new instance of CancelGoodsReceiptUseCase
    pub fn new(receipt_repo: Arc<G>) -> Self {
        Self { receipt_repo }
    }

    /// Executes the use case to cancel a goods receipt
    ///
    /// # Arguments
    /// * `receipt_id` - The ID of the goods receipt to cancel
    ///
    /// # Returns
